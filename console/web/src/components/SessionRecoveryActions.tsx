...
export function SessionRecoveryActions({ beforeCheck }: { beforeCheck?: () => void } = {}) {
  ...
  return <SpaceBetween direction="horizontal" size="xs">
    ...
    <Button loading={auth.checking} onClick={() => { beforeCheck?.(); void authSession.check(); }}>Check sign-in</Button>
  </SpaceBetween>;
}
