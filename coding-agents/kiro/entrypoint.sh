...
# Both binaries have 20s child limits; final collector readiness must follow them.
# The CLI probes plus the collector gate remain below 104s.
python3 /opt/workshop-cli/cli_versions.py verify --cli kiro --home "$HOME" >/dev/null
